class Gene {
    constructor(seedStr) {
        ...
        this.value = getNormallyDistributedRandomNumber(0.5, 0.175, random);
    }
...
class Genes {
    ...
    mutate(newWord) {
        ...
        const idx = Math.floor(Math.random() * this._genes.length);
        this._genes[idx] = new Gene(newWord);
    }
}

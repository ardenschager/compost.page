...
class Simulation {
    ...
    spawnPlant() {
        let row = Math.floor(getNormallyDistributedRandomNumber(this.grid.numRows / 2, this.grid.numRows / 4.5));
        let col = Math.floor(getNormallyDistributedRandomNumber(this.grid.numCols / 2, this.grid.numCols / 4.5));
